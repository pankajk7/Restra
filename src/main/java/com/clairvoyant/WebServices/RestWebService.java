...
import com.clairvoyant.Utils.AlertMessage;
...
public class RestWebService {
    ...
    public void serviceCall(String resourceName, String extraParameters, boolean showLoading) {
        ...
        if (resourceName.equalsIgnoreCase(Constants.API_GET_RESTAURANT)) {
            ...
            getCall(url);
        } else if (resourceName.equalsIgnoreCase(Constants.API_GET_AREA)) {
            getCall(url);
        ...
        StringRequest req = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String data) {
                ...
                try {
                    ...
                    if (jsonObject.has(context.getResources().getString(R.string.error_webservice_response_message))) {
                        new AlertMessage(context).showTostMessage(jsonObject.getString("message"));
                    } else {
                        onSuccess(data);
                    }
